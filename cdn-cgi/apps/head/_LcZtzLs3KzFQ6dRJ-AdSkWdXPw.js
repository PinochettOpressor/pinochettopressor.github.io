;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="a384625b54e925ea5d35dbe513583d34";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["9zKaeJZJNp1d"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["9zKaeJZJNp1d"].options={"blocks":[{"code":"","location":{"method":"replace","pages":{"URLPatterns":["^pinochettopressor.eu.org/?.*$"]},"selector":"#header-text-nav-wrap"}}]};;CloudflareApps.installs["9zKaeJZJNp1d"].selectors={"blocks[0].location.selector":"#header-text-nav-wrap"};;if(CloudflareApps.matchPage(CloudflareApps.installs['9zKaeJZJNp1d'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['9zKaeJZJNp1d'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['9zKaeJZJNp1d'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}